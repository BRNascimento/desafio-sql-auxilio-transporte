...
1-Criacao-Tabelas.sql: Execute para criar a estrutura de tabelas.

2-Programacao-Trigger.sql: Execute para instalar a lógica de auditoria.

3-Programacao-Proc.sql: Execute para criar a Stored Procedure de cancelamento.

4-Insercao-Dados.sql: Execute para popular o banco.

5-Consultas.sql: Execute para visualizar os relatórios e rankings.

6-Testes-e-Validacao.sql: Execute para validar a Procedure e os logs.
